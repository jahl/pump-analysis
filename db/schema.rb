...
ActiveRecord::Schema[7.1].define(version: 2024_02_12_201641) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "operating_loads", force: :cascade do |t|
    ...
    t.index ["pump_id"], name: "index_operating_loads_on_pump_id"
  end
  ...
  add_foreign_key "operating_loads", "pumps"
end
